...
function showPubs(id) {
    if (id == 0) {
        ...
        document.getElementById('select0').style = 'color:#ffde00';
        ...
        document.getElementById('select1').style = 'color:#ffde00';
        ...
        document.getElementById('select2').style = 'color:#ffde00';
        document.getElementById('select0').style = '';
        document.getElementById('select1').style = '';
    }
}